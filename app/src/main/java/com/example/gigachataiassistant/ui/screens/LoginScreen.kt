...
import com.example.gigachataiassistant.ui.theme.LoginScreenAnimationMillis
import com.example.gigachataiassistant.ui.theme.LoginScreenCredentialFieldsSlideOffsetDivisor
...
private fun LoginScreenBody(
    ...
    val fieldsEnter = remember {
        fadeIn(
            animationSpec = tween(
                durationMillis = LoginScreenAnimationMillis.CredentialFieldsEnter,
                easing = FastOutSlowInEasing,
            ),
        ) + slideInVertically(
            initialOffsetY = { fullHeight -> fullHeight / LoginScreenCredentialFieldsSlideOffsetDivisor },
            animationSpec = tween(
                durationMillis = LoginScreenAnimationMillis.CredentialFieldsEnter,
                easing = FastOutSlowInEasing,
            ),
...
@Composable
private fun LoginGoogleSignInSection(
    modifier: Modifier,
    enabled: Boolean,
    onGoogleSignInClick: () -> Unit,
) {
